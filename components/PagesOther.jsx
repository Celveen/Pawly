  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 60, display: 'grid', placeItems: 'center', padding: 16 }}>
      ...
      <div role="dialog" aria-label={mode === 'register' ? '注册' : '登录'} style={{
        ...
        <div style={{ position: 'relative' }}>
          <input className="input" type={showPw ? 'text' : 'password'} placeholder="至少 8 位，含字母和数字"
        ...
        {mode === 'register' && (
          <>
            ...
            <input className="input" type={showPw ? 'text' : 'password'} placeholder="再输入一次" autoComplete="new-password"
